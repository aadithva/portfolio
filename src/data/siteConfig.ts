...
export const siteConfig: SiteConfig = {
  name: "Aadith V A",
  title: "Aadith V A — AI Product Designer & Founder",
  description:
    "Product designer at Microsoft and co-founder of Owly, working on trustworthy AI response UX, brand-aware creative infrastructure, and prototypes that move from Figma into code.",
