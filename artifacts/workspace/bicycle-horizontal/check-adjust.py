...
bike.matrix_world=Matrix.Translation(C+3.45*T+1.75*U+.45*N)@Matrix.Scale(.72,4)@Matrix.Translation(-origin)@bike.matrix_world
...
for s in [3.25,3.60]:
 ...
 tube('frame support arm',[(s,1.90,.10),(s,1.96,.40),(s,1.96,.50)],.019,steel)
 tube('padded frame cradle',[(s,2.015,.38),(s,1.965,.43),(s,1.965,.49),(s,2.015,.54)],.026,rubber)
