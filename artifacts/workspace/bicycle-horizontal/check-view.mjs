...
await page.screenshot({path:'artifacts/workspace/bicycle-horizontal/overview.png'});
for(const [name,dx,dy] of [['left',-1100,-700],['right',1100,700]]) {
 ...
 await page.screenshot({path:`artifacts/workspace/bicycle-horizontal/${name}.png`});
}
await browser.close();
