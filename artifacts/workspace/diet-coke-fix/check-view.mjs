...
await page.screenshot({path:'artifacts/workspace/diet-coke-fix/desk-detail.png'});
await page.screenshot({path:'artifacts/workspace/diet-coke-fix/can-closeup.png',clip:{x:990,y:590,width:160,height:190}});
